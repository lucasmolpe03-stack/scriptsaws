#!/usr/bin/env python3
"""
Versión 4: Crear VPC, Subnet, Internet Gateway y Route Table
...
def main():
    try:
        ...
        print("\n[4/9] Habilitando asignación automática de IP pública...")
        ec2.modify_subnet_attribute(SubnetId=subnet_id, MapPublicIpOnLaunch={'Value': True})
        print("✓ IP pública automática habilitada")
        
        # 5. Crear Internet Gateway
        print("\n[5/9] Creando Internet Gateway...")
        ...
        print("\n[6/9] Adjuntando Internet Gateway a la VPC...")
